# RailsAdmin config file. Generated on February 29, 2012 06:59
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Oseh Occasions', 'Admin']
  ...
  # config.excluded_models = [Event, Household, Person]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Event, Household, Person]
  ...
  #     configure :parent_id, :integer         # Hidden   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :main_phone, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
